				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						if (isset($_POST["daftar"]))
						{
							...
							{
								//query insert ke tabel pelamggan
								$koneksi->query("INSERT INTO pelanggan(email,password,nama,no_hp,alamat_pelanggan) VALUES('$email','$password','$nama','$telepon','$alamat') ");
